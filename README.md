...
3. Запустите проект:
    ```bash
   java -jar target/UniversityGroups-0.0.1-SNAPSHOT.jar

4. Если всё прошло успешно, то в терминале вы увидите аналогичную надпись:
   ```bash
   2025-05-18T15:09:58.885+07:00  INFO 31432 --- [UniversityGroups] [           main] .s.c.t.ConvenientSoftwareTaskApplication : Started ConvenientSoftwareTaskApplication in 1.388 seconds (process running for 1.677)

### Запуск в IntelliJ IDEA:
1. Перейдите в папку: ```src/main/java/ru/safonov/apps/universitygroups```

2. Откройте класс ```UniversityGroupsApplication.java``` и запустите его нажав пункт меню ```Run```
